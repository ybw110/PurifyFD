...
def main():
    ...
    # OOD1
    # MODEL_PATH = '/data2/ybw25/轴承DG/实验self1+self2+OOD/results/aminet_OOD1/AMINet_SelfA_Multi_1200_1800_20260126_124520/best_model.pth'
    # MODEL_PATH = '/data2/ybw25/轴承DG/实验self1+self2+OOD/results/aminet_OOD1/AMINet_SelfA_Single_1200_20260126_123519/best_model.pth'
    # MODEL_PATH = '/data2/ybw25/轴承DG/实验self1+self2+OOD/results/aminet_OOD1/AMINet_SelfA_Single_1800_20260126_123729/best_model.pth'
    #
    # MODEL_PATH = '/data2/ybw25/轴承DG/实验self1+self2+OOD/results/aminet_OOD1/AMINet_SelfB_Multi_1200_1800_20260126_124819/best_model.pth'
    # MODEL_PATH = '/data2/ybw25/轴承DG/实验self1+self2+OOD/results/aminet_OOD1/AMINet_SelfB_Single_1200_20260126_123919/best_model.pth'
    # MODEL_PATH = '/data2/ybw25/轴承DG/实验self1+self2+OOD/results/aminet_OOD1/AMINet_SelfB_Single_1800_20260126_124207/best_model.pth'

    # OOD2
    # MODEL_PATH = '/data2/ybw25/轴承DG/实验self1+self2+OOD/results/aminet_OOD2/AMINet_SelfA_Multi_1200_1800_20260126_165226/best_model.pth'
    # MODEL_PATH = '/data2/ybw25/轴承DG/实验self1+self2+OOD/results/aminet_OOD2/AMINet_SelfA_Single_1200_20260126_164327/best_model.pth'
    # MODEL_PATH = '/data2/ybw25/轴承DG/实验self1+self2+OOD/results/aminet_OOD2/AMINet_SelfA_Single_1800_20260126_164729/best_model.pth'

    # MODEL_PATH = '/data2/ybw25/轴承DG/实验self1+self2+OOD/results/aminet_OOD2/AMINet_SelfB_Multi_1200_1800_20260126_165343/best_model.pth'
    # MODEL_PATH = '/data2/ybw25/轴承DG/实验self1+self2+OOD/results/aminet_OOD2/AMINet_SelfB_Single_1200_20260126_164852/best_model.pth'
    MODEL_PATH = '/data2/ybw25/轴承DG/实验self1+self2+OOD/results/aminet_OOD2/AMINet_SelfB_Single_1800_20260126_165015/best_model.pth'
