...
def main():
    ...
    # [新增] 打印 OOD 配置确认
    print("\n" + "=" * 40)
    print(" MIXSTYLE OOD TRAINING CONFIG")
    ...
    print(f"MixStyle Config: p={MIXSTYLE_P}, alpha={MIXSTYLE_ALPHA}")
    ...
    save_dir = os.path.join('results', 'mixstyle_cnn_OOD3', f'{task_name}_{timestamp}')
