...
def main():
    ...
    # 加载权重,CWRU多域
    # seed42
    # MODEL_PATH = '/data2/ybw25/轴承DG/实验CWRU+JNU/results/sample_cnn/MultiSource_0HP_1HP_2HP_20260102_164425/best_model.pth'
    # MODEL_PATH = '/data2/ybw25/轴承DG/实验CWRU+JNU/results/sample_cnn/MultiSource_0HP_1HP_2HP_3HP_20260102_164755/best_model.pth'
    # MODEL_PATH = '/data2/ybw25/轴承DG/实验CWRU+JNU/results/sample_cnn/MultiSource_0HP_1HP_3HP_20260102_164514/best_model.pth'
    # MODEL_PATH = '/data2/ybw25/轴承DG/实验CWRU+JNU/results/sample_cnn/MultiSource_0HP_2HP_3HP_20260102_164555/best_model.pth'
    # MODEL_PATH = '/data2/ybw25/轴承DG/实验CWRU+JNU/results/sample_cnn/MultiSource_1HP_2HP_3HP_20260102_164652/best_model.pth'
    #
    # MODEL_PATH = '/data2/ybw25/轴承DG/实验CWRU+JNU/results/sample_cnn/MultiSource_600_1000_20260102_165156/best_model.pth'
    # MODEL_PATH = '/data2/ybw25/轴承DG/实验CWRU+JNU/results/sample_cnn/MultiSource_600_800_1000_20260102_164908/best_model.pth'
    # MODEL_PATH = '/data2/ybw25/轴承DG/实验CWRU+JNU/results/sample_cnn/MultiSource_600_800_20260102_165326/best_model.pth'
    # MODEL_PATH = '/data2/ybw25/轴承DG/实验CWRU+JNU/results/sample_cnn/MultiSource_800_1000_20260102_165431/best_model.pth'
    #
    # # seed28
    # MODEL_PATH = '/data2/ybw25/轴承DG/实验CWRU+JNU/results/sample_cnn/MultiSource_0HP_1HP_2HP_20260104_180911/best_model.pth'
    # MODEL_PATH = '/data2/ybw25/轴承DG/实验CWRU+JNU/results/sample_cnn/MultiSource_0HP_1HP_2HP_3HP_20260104_181344/best_model.pth'
    # MODEL_PATH = '/data2/ybw25/轴承DG/实验CWRU+JNU/results/sample_cnn/MultiSource_0HP_1HP_3HP_20260104_181033/best_model.pth'
    # MODEL_PATH = '/data2/ybw25/轴承DG/实验CWRU+JNU/results/sample_cnn/MultiSource_0HP_2HP_3HP_20260104_175844/best_model.pth'
    # MODEL_PATH = '/data2/ybw25/轴承DG/实验CWRU+JNU/results/sample_cnn/MultiSource_1HP_2HP_3HP_20260104_181221/best_model.pth'

    # MODEL_PATH = '/data2/ybw25/轴承DG/实验CWRU+JNU/results/sample_cnn/MultiSource_600_1000_20260104_175718/best_model.pth'
    # MODEL_PATH = '/data2/ybw25/轴承DG/实验CWRU+JNU/results/sample_cnn/MultiSource_600_800_1000_20260104_174955/best_model.pth'
    # MODEL_PATH = '/data2/ybw25/轴承DG/实验CWRU+JNU/results/sample_cnn/MultiSource_600_800_20260104_175540/best_model.pth'
    MODEL_PATH = '/data2/ybw25/轴承DG/实验CWRU+JNU/results/sample_cnn/MultiSource_800_1000_20260104_175424/best_model.pth'
