...
def main():
    ...
    # OOD1
    # MODEL_PATH = '/data2/ybw25/轴承DG/实验CWRU+JNU+OOD/results/sample_cnn_OOD1/SingleSource_0HP_20260103_201447/best_model.pth'
    # MODEL_PATH = '/data2/ybw25/轴承DG/实验CWRU+JNU+OOD/results/sample_cnn_OOD1/SingleSource_3HP_20260103_201521/best_model.pth'
    # MODEL_PATH = '/data2/ybw25/轴承DG/实验CWRU+JNU+OOD/results/sample_cnn_OOD1/MultiSource_0HP_1HP_2HP_20260103_201630/best_model.pth'
    # MODEL_PATH = '/data2/ybw25/轴承DG/实验CWRU+JNU+OOD/results/sample_cnn_OOD1/MultiSource_0HP_1HP_2HP_3HP_20260103_201339/best_model.pth'
    # MODEL_PATH = '/data2/ybw25/轴承DG/实验CWRU+JNU+OOD/results/sample_cnn_OOD1/SingleSource_600_20260103_201548/best_model.pth'
    # MODEL_PATH = '/data2/ybw25/轴承DG/实验CWRU+JNU+OOD/results/sample_cnn_OOD1/MultiSource_600_800_20260103_201708/best_model.pth'
    # MODEL_PATH = '/data2/ybw25/轴承DG/实验CWRU+JNU+OOD/results/sample_cnn_OOD1/MultiSource_600_800_1000_20260103_201110/best_model.pth'

    # OOD2
    # MODEL_PATH = '/data2/ybw25/轴承DG/实验CWRU+JNU+OOD/results/sample_cnn_OOD2/SingleSource_0HP_20260103_133157/best_model.pth'
    # MODEL_PATH = '/data2/ybw25/轴承DG/实验CWRU+JNU+OOD/results/sample_cnn_OOD2/SingleSource_3HP_20260103_133134/best_model.pth'
    # MODEL_PATH = '/data2/ybw25/轴承DG/实验CWRU+JNU+OOD/results/sample_cnn_OOD2/MultiSource_0HP_1HP_2HP_20260103_133300/best_model.pth'
    # MODEL_PATH = '/data2/ybw25/轴承DG/实验CWRU+JNU+OOD/results/sample_cnn_OOD2/MultiSource_0HP_1HP_2HP_3HP_20260103_132246/best_model.pth'
    # MODEL_PATH = '/data2/ybw25/轴承DG/实验CWRU+JNU+OOD/results/sample_cnn_OOD2/SingleSource_600_20260103_133224/best_model.pth'
    MODEL_PATH = '/data2/ybw25/轴承DG/实验CWRU+JNU+OOD/results/sample_cnn_OOD2/MultiSource_600_800_20260103_133326/best_model.pth'
    # MODEL_PATH = '/data2/ybw25/轴承DG/实验CWRU+JNU+OOD/results/sample_cnn_OOD2/MultiSource_600_800_1000_20260103_132158/best_model.pth'
    #
