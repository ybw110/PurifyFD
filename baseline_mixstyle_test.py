...
# === 导入自定义模块 ===
from baseline_mixstyle_model import MixStyleCNN # 导入
...
def main():
    ...
    # === 配置：此处填写训练好的模型路径 ===
    # seed42
    # MODEL_PATH = '/data2/ybw25/轴承DG/实验CWRU+JNU/results/mixstyle_cnn/MultiSource_0HP_1HP_2HP_20260104_174620/best_model.pth'
    # MODEL_PATH = '/data2/ybw25/轴承DG/实验CWRU+JNU/results/mixstyle_cnn/MultiSource_0HP_1HP_2HP_3HP_20260104_174253/best_model.pth'
    # MODEL_PATH = '/data2/ybw25/轴承DG/实验CWRU+JNU/results/mixstyle_cnn/MultiSource_0HP_1HP_3HP_20260104_174709/best_model.pth'
    # MODEL_PATH = '/data2/ybw25/轴承DG/实验CWRU+JNU/results/mixstyle_cnn/MultiSource_0HP_2HP_3HP_20260104_174753/best_model.pth'
    # MODEL_PATH = '/data2/ybw25/轴承DG/实验CWRU+JNU/results/mixstyle_cnn/MultiSource_1HP_2HP_3HP_20260104_174505/best_model.pth'
    #
    # MODEL_PATH = '/data2/ybw25/轴承DG/实验CWRU+JNU/results/mixstyle_cnn/MultiSource_600_1000_20260104_173600/best_model.pth'
    # MODEL_PATH = '/data2/ybw25/轴承DG/实验CWRU+JNU/results/mixstyle_cnn/MultiSource_600_800_1000_20260104_173711/best_model.pth'
    # MODEL_PATH = '/data2/ybw25/轴承DG/实验CWRU+JNU/results/mixstyle_cnn/MultiSource_600_800_20260104_173450/best_model.pth'
    # MODEL_PATH = '/data2/ybw25/轴承DG/实验CWRU+JNU/results/mixstyle_cnn/MultiSource_800_1000_20260104_173237/best_model.pth'
    #
    # # seed24
    # MODEL_PATH = '/data2/ybw25/轴承DG/实验CWRU+JNU/results/mixstyle_cnn/MultiSource_0HP_1HP_2HP_20260104_180923/best_model.pth'
    # MODEL_PATH = '/data2/ybw25/轴承DG/实验CWRU+JNU/results/mixstyle_cnn/MultiSource_0HP_1HP_2HP_3HP_20260104_181351/best_model.pth'
    # MODEL_PATH = '/data2/ybw25/轴承DG/实验CWRU+JNU/results/mixstyle_cnn/MultiSource_0HP_1HP_3HP_20260104_181036/best_model.pth'
    # MODEL_PATH = '/data2/ybw25/轴承DG/实验CWRU+JNU/results/mixstyle_cnn/MultiSource_0HP_2HP_3HP_20260104_175835/best_model.pth'
    # MODEL_PATH = '/data2/ybw25/轴承DG/实验CWRU+JNU/results/mixstyle_cnn/MultiSource_1HP_2HP_3HP_20260104_181224/best_model.pth'
    #
    # MODEL_PATH = '/data2/ybw25/轴承DG/实验CWRU+JNU/results/mixstyle_cnn/MultiSource_600_1000_20260104_175442/best_model.pth'
    # MODEL_PATH = '/data2/ybw25/轴承DG/实验CWRU+JNU/results/mixstyle_cnn/MultiSource_600_800_1000_20260104_175027/best_model.pth'
    # MODEL_PATH = '/data2/ybw25/轴承DG/实验CWRU+JNU/results/mixstyle_cnn/MultiSource_600_800_20260104_175556/best_model.pth'
    MODEL_PATH = '/data2/ybw25/轴承DG/实验CWRU+JNU/results/mixstyle_cnn/MultiSource_800_1000_20260104_175659/best_model.pth'
    ...
    try:
        ...
        print(f"Loaded MixStyle model from {MODEL_PATH}")
