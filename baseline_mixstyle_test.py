...
def main():
    ...
    # OOD1
    # MODEL_PATH = '/data2/ybw25/轴承DG/实验self1+self2+OOD/results/mixstyle_cnn_OOD1/MixStyle_SelfA_Multi_1200_1800_20260126_124510/best_model.pth'
    # MODEL_PATH = '/data2/ybw25/轴承DG/实验self1+self2+OOD/results/mixstyle_cnn_OOD1/MixStyle_SelfA_Single_1200_20260126_123506/best_model.pth'
    # MODEL_PATH = '/data2/ybw25/轴承DG/实验self1+self2+OOD/results/mixstyle_cnn_OOD1/MixStyle_SelfA_Single_1800_20260126_123739/best_model.pth'
    # MODEL_PATH = '/data2/ybw25/轴承DG/实验self1+self2+OOD/results/mixstyle_cnn_OOD1/MixStyle_SelfB_Multi_1200_1800_20260126_124809/best_model.pth'
    # MODEL_PATH = '/data2/ybw25/轴承DG/实验self1+self2+OOD/results/mixstyle_cnn_OOD1/MixStyle_SelfB_Single_1200_20260126_123908/best_model.pth'
    # MODEL_PATH = '/data2/ybw25/轴承DG/实验self1+self2+OOD/results/mixstyle_cnn_OOD1/MixStyle_SelfB_Single_1800_20260126_124218/best_model.pth'

    # OOD2
    # MODEL_PATH = '/data2/ybw25/轴承DG/实验self1+self2+OOD/results/mixstyle_cnn_OOD2/MixStyle_SelfA_Multi_1200_1800_20260126_165215/best_model.pth'
    # MODEL_PATH = '/data2/ybw25/轴承DG/实验self1+self2+OOD/results/mixstyle_cnn_OOD2/MixStyle_SelfA_Single_1200_20260126_164322/best_model.pth'
    # MODEL_PATH = '/data2/ybw25/轴承DG/实验self1+self2+OOD/results/mixstyle_cnn_OOD2/MixStyle_SelfA_Single_1800_20260126_164739/best_model.pth'
    # MODEL_PATH = '/data2/ybw25/轴承DG/实验self1+self2+OOD/results/mixstyle_cnn_OOD2/MixStyle_SelfB_Multi_1200_1800_20260126_165355/best_model.pth'
    # MODEL_PATH = '/data2/ybw25/轴承DG/实验self1+self2+OOD/results/mixstyle_cnn_OOD2/MixStyle_SelfB_Single_1200_20260126_164841/best_model.pth'
    MODEL_PATH = '/data2/ybw25/轴承DG/实验self1+self2+OOD/results/mixstyle_cnn_OOD2/MixStyle_SelfB_Single_1800_20260126_165024/best_model.pth'
