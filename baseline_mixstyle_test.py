...
def main():
    ...
    # -------- 方式 A：手动指定（只测一个模型）--------
    # MODEL_PATH = '/data2/ybw25/轴承DG/实验self1+self2/results/mixstyle_cnn/MixStyle_SelfA_Single_1200_1/best_model.pth'
    # MODEL_PATH = '/data2/ybw25/轴承DG/实验self1+self2/results/mixstyle_cnn/MixStyle_SelfA_Single_1800_1/best_model.pth'
    # MODEL_PATH = '/data2/ybw25/轴承DG/实验self1+self2/results/mixstyle_cnn/MixStyle_SelfA_Multi_1200_1800_1/best_model.pth'

    # MODEL_PATH = '/data2/ybw25/轴承DG/实验self1+self2/results/mixstyle_cnn/MixStyle_SelfB_Single_1200_1/best_model.pth'
    # MODEL_PATH = '/data2/ybw25/轴承DG/实验self1+self2/results/mixstyle_cnn/MixStyle_SelfB_Single_1800_1/best_model.pth'
    # MODEL_PATH = '/data2/ybw25/轴承DG/实验self1+self2/results/mixstyle_cnn/MixStyle_SelfB_Multi_1200_1800_1/best_model.pth'

    #28
    # MODEL_PATH = '/data2/ybw25/轴承DG/实验self1+self2/results/mixstyle_cnn/MixStyle_SelfA_Single_1200_20260124_145705/best_model.pth'
    # MODEL_PATH = '/data2/ybw25/轴承DG/实验self1+self2/results/mixstyle_cnn/MixStyle_SelfA_Single_1800_20260124_145620/best_model.pth'
    # MODEL_PATH = '/data2/ybw25/轴承DG/实验self1+self2/results/mixstyle_cnn/MixStyle_SelfA_Multi_1200_1800_20260124_145416/best_model.pth'

    # MODEL_PATH = '/data2/ybw25/轴承DG/实验self1+self2/results/mixstyle_cnn/MixStyle_SelfB_Single_1200_20260124_145535/best_model.pth'
    # MODEL_PATH = '/data2/ybw25/轴承DG/实验self1+self2/results/mixstyle_cnn/MixStyle_SelfB_Single_1800_20260124_145454/best_model.pth'
    MODEL_PATH = '/data2/ybw25/轴承DG/实验self1+self2/results/mixstyle_cnn/MixStyle_SelfB_Multi_1200_1800_20260124_145321/best_model.pth'
    ...
    #         title="MixStyle: A1200 (Source) vs A1800 (Target)"
    #     )
    #
    ...
    #     title="MixStyle: SelfA (Source) vs SelfB (Target)"
    # )
