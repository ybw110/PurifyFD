...
def test_pipeline(model, test_loader, device='cuda', score_type='energy', T=1.0):
    ...
    with torch.no_grad():
        for batch_data in test_loader:
            ...
            # DACN 推理: 使用 forward_pretrain (F->G->C)
...
def main():
    ...
    # OOD1
    # MODEL_PATH = '/data2/ybw25/轴承DG/实验CWRU+JNU+OOD/results/dacn_OOD1/DACN_Multi_0HP_1HP_2HP_20260125_231849/best_model.pth'
    # MODEL_PATH = '/data2/ybw25/轴承DG/实验CWRU+JNU+OOD/results/dacn_OOD1/DACN_Multi_0HP_1HP_2HP_3HP_20260126_114050/best_model.pth'
    # MODEL_PATH = '/data2/ybw25/轴承DG/实验CWRU+JNU+OOD/results/dacn_OOD1/DACN_Multi_600_800_1000_20260126_114505/best_model.pth'
    # MODEL_PATH = '/data2/ybw25/轴承DG/实验CWRU+JNU+OOD/results/dacn_OOD1/DACN_Multi_600_800_20260126_113519/best_model.pth'
    # MODEL_PATH = '/data2/ybw25/轴承DG/实验CWRU+JNU+OOD/results/dacn_OOD1/DACN_Single_0HP_20260125_231451/best_model.pth'
    # MODEL_PATH = '/data2/ybw25/轴承DG/实验CWRU+JNU+OOD/results/dacn_OOD1/DACN_Single_3HP_20260125_231411/best_model.pth'
    # MODEL_PATH = '/data2/ybw25/轴承DG/实验CWRU+JNU+OOD/results/dacn_OOD1/DACN_Single_600_20260125_231529/best_model.pth'

    # OOD2
    # MODEL_PATH = '/data2/ybw25/轴承DG/实验CWRU+JNU+OOD/results/dacn_OOD2/DACN_Multi_0HP_1HP_2HP_20260126_120809/best_model.pth'
    # MODEL_PATH = '/data2/ybw25/轴承DG/实验CWRU+JNU+OOD/results/dacn_OOD2/DACN_Multi_0HP_1HP_2HP_3HP_20260126_120012/best_model.pth'
    # MODEL_PATH = '/data2/ybw25/轴承DG/实验CWRU+JNU+OOD/results/dacn_OOD2/DACN_Multi_600_800_1000_20260126_115146/best_model.pth'
    # MODEL_PATH = '/data2/ybw25/轴承DG/实验CWRU+JNU+OOD/results/dacn_OOD2/DACN_Multi_600_800_20260126_121111/best_model.pth'
    # MODEL_PATH = '/data2/ybw25/轴承DG/实验CWRU+JNU+OOD/results/dacn_OOD2/DACN_Single_0HP_20260126_120348/best_model.pth'
    # MODEL_PATH = '/data2/ybw25/轴承DG/实验CWRU+JNU+OOD/results/dacn_OOD2/DACN_Single_3HP_20260126_120441/best_model.pth'
    MODEL_PATH = '/data2/ybw25/轴承DG/实验CWRU+JNU+OOD/results/dacn_OOD2/DACN_Single_600_20260126_120609/best_model.pth'
    ...
    save_path = os.path.join(results_dir, 'dacn_ood_benchmark.csv')
    df.to_csv(save_path, index=False)
    print(f"\n✅ Results saved to: {save_path}")

    txt_save_path = os.path.join(results_dir, 'dacn_ood_benchmark.txt')
