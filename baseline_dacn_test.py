...
def main():
    ...
    # OOD1
    # MODEL_PATH = '/data2/ybw25/轴承DG/实验self1+self2+OOD/results/dacn_OOD1/DACN_SelfA_Multi_1200_1800_20260126_124515/best_model.pth'
    # MODEL_PATH = '/data2/ybw25/轴承DG/实验self1+self2+OOD/results/dacn_OOD1/DACN_SelfA_Single_1200_20260126_123510/best_model.pth'
    # MODEL_PATH = '/data2/ybw25/轴承DG/实验self1+self2+OOD/results/dacn_OOD1/DACN_SelfA_Single_1800_20260126_123734/best_model.pth'
    # MODEL_PATH = '/data2/ybw25/轴承DG/实验self1+self2+OOD/results/dacn_OOD1/DACN_SelfB_Multi_1200_1800_20260126_124814/best_model.pth'
    # MODEL_PATH = '/data2/ybw25/轴承DG/实验self1+self2+OOD/results/dacn_OOD1/DACN_SelfB_Single_1200_20260126_123914/best_model.pth'
    # MODEL_PATH = '/data2/ybw25/轴承DG/实验self1+self2+OOD/results/dacn_OOD1/DACN_SelfB_Single_1800_20260126_124212/best_model.pth'

    # OOD2
    # MODEL_PATH = '/data2/ybw25/轴承DG/实验self1+self2+OOD/results/dacn_OOD2/DACN_SelfA_Multi_1200_1800_20260126_165221/best_model.pth'
    # MODEL_PATH = '/data2/ybw25/轴承DG/实验self1+self2+OOD/results/dacn_OOD2/DACN_SelfA_Single_1200_20260126_164325/best_model.pth'
    # MODEL_PATH = '/data2/ybw25/轴承DG/实验self1+self2+OOD/results/dacn_OOD2/DACN_SelfA_Single_1800_20260126_164734/best_model.pth'
    # MODEL_PATH = '/data2/ybw25/轴承DG/实验self1+self2+OOD/results/dacn_OOD2/DACN_SelfB_Multi_1200_1800_20260126_165350/best_model.pth'
    # MODEL_PATH = '/data2/ybw25/轴承DG/实验self1+self2+OOD/results/dacn_OOD2/DACN_SelfB_Single_1200_20260126_164846/best_model.pth'
    MODEL_PATH = '/data2/ybw25/轴承DG/实验self1+self2+OOD/results/dacn_OOD2/DACN_SelfB_Single_1800_20260126_165020/best_model.pth'
