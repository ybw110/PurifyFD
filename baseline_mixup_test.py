...
def main():
    ...
    # OOD1
    # MODEL_PATH = '/data2/ybw25/轴承DG/实验self1+self2+OOD/results/mixup_cnn_OOD1/Mixup_SelfA_Multi_1200_1800_20260126_124504/best_model.pth'
    # MODEL_PATH = '/data2/ybw25/轴承DG/实验self1+self2+OOD/results/mixup_cnn_OOD1/Mixup_SelfA_Single_1200_20260126_123502/best_model.pth'
    # MODEL_PATH = '/data2/ybw25/轴承DG/实验self1+self2+OOD/results/mixup_cnn_OOD1/Mixup_SelfA_Single_1800_20260126_123745/best_model.pth'
    #
    # MODEL_PATH = '/data2/ybw25/轴承DG/实验self1+self2+OOD/results/mixup_cnn_OOD1/Mixup_SelfB_Multi_1200_1800_20260126_124803/best_model.pth'
    # MODEL_PATH = '/data2/ybw25/轴承DG/实验self1+self2+OOD/results/mixup_cnn_OOD1/Mixup_SelfB_Single_1200_20260126_123903/best_model.pth'
    # MODEL_PATH = '/data2/ybw25/轴承DG/实验self1+self2+OOD/results/mixup_cnn_OOD1/Mixup_SelfB_Single_1800_20260126_124223/best_model.pth'
    #
    # OOD2
    # MODEL_PATH = '/data2/ybw25/轴承DG/实验self1+self2+OOD/results/mixup_cnn_OOD2/Mixup_SelfA_Multi_1200_1800_20260126_165210/best_model.pth'
    # MODEL_PATH = '/data2/ybw25/轴承DG/实验self1+self2+OOD/results/mixup_cnn_OOD2/Mixup_SelfA_Single_1200_20260126_164320/best_model.pth'
    # MODEL_PATH = '/data2/ybw25/轴承DG/实验self1+self2+OOD/results/mixup_cnn_OOD2/Mixup_SelfA_Single_1800_20260126_164745/best_model.pth'

    # MODEL_PATH = '/data2/ybw25/轴承DG/实验self1+self2+OOD/results/mixup_cnn_OOD2/Mixup_SelfB_Multi_1200_1800_20260126_165400/best_model.pth'
    # MODEL_PATH = '/data2/ybw25/轴承DG/实验self1+self2+OOD/results/mixup_cnn_OOD2/Mixup_SelfB_Single_1200_20260126_164836/best_model.pth'
    MODEL_PATH = '/data2/ybw25/轴承DG/实验self1+self2+OOD/results/mixup_cnn_OOD2/Mixup_SelfB_Single_1800_20260126_165029/best_model.pth'
